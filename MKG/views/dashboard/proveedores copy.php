                ...
                <form class="col s12">
                    <div class="row">
                        ...
                        <div class="input-field btn col s12 m4 offset-m4 l3 offset-l4" id="combobox">                        
                            ...
                            <option value="" data-icon="">Bloqueado</option>
                            </select>                   
                        </div>
                    </div>                 
                </form>
        ...
        <div class="card-panel">       
            <div class="center ">            
                ...
                <div class="input-field btn col s12 m8 l8 offset-l2  offset-m2" id="combobox">
                    ...
                    <option value="" data-icon="">Mauricio</option>
                    <option value="" data-icon="">Katherine</option>
                    <option value="" data-icon="">Gisselle</option>
                    </select>                   
                </div>           
            <br><br>
