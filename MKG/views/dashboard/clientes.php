...
Dashboard_template::headerDashboard('Clientes','../../resources/css/dashboard/proveedores.css');
?>
...
<div id="modaladd" class="modal">
    ...
    <div class="modal-content">
        <h4 class="center">Agregar Cliente</h4>
        <div class="" id="form">
            <div class="row card-panel">
                <form class="col s12">
                    <div class="row">
                        ...
                        <div class="input-field col s12 m6 l6">
                            <input id="last_name" type="password" class="validate" required>
...
<?php
Dashboard_template::footerDashboard('clientes.js');
?>