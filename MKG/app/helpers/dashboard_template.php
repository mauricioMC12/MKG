...
public static function headerDashboard($title,$diseño){
  print('
        ...
        <head>
            ...
            <link type="text/css" rel="stylesheet" href="'.$diseño.'" />   
        ...
        <body  class="amber lighten-3">
               ...
               <!-- <--!<i class="material-icons prefix">account_circle</i>
                        <input id="icon_nombres" type="text" class="validate"  value="Publico" placeholder="Nombres">
                        </div>¡--> 
                    ...
                    <nav class="teal lighten-3">
                        <div class="nav-wrapper">
                            ...
                            <ul class="right hide-on-med-and-down">
                                <li><a href="../../views/dashboard/index.php" data-position="bottom" data-tooltip="Menu Principal" class="tooltipped"><i class="Medium material-icons black-text">home</i></li></a>
                                <li>
                                <li><a href="../../views/dashboard/profileDashboard.php" data-position="bottom" data-tooltip="Mi Perfil" class="tooltipped"><i class="Medium material-icons black-text">account_circle</i></li></a>
                ...
                <ul id="dropdown1" class="dropdown-content">
                    ...
                    <li><a href="../../views/dashboard/proveedores.php"><i class="Medium material-icons black-text">favorite</i>Proveedores</li></a>
                    <li><a href="../../views/dashboard/inventario.php"><i class=" material-icons black-text">local_grocery_store</i>Inventario</li></a>
                    ...
                    <ul id="slide-out" class="sidenav right">
                        <li>
                            <div class="user-view">
                                ...
                                <a href="#user"><img class="circle" src="../../resources/img/Menu/usuarios.png"></a>
